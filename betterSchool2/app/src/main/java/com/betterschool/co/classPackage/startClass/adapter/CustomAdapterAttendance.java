package com.betterschool.co.classPackage.startClass.adapter;
...
public class CustomAdapterAttendance extends RecyclerView.Adapter<CustomAdapterAttendance.viewHolderAttendance> {
    ...
    public CustomAdapterAttendance(List<students> list, Context context, com.betterschool.co.classPackage.startClass.adapter.changeStudentStatus changeStudentStatus) {
        this.list = list;
